...
public class Global {
    ...
    public Global(int newConfirmedCases, int totalConfirmedCases, int newDeathsCases,
                  int totalDeathsCases, int newRecoveredCases, int totalRecoveredCases, String date) {
